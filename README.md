...
<p>Networking and Security technology is the most advanced technology in today&rsquo;s world. The world is now connected with various networks in and around us. Being it wired or wireless, networking fundamentals are the pillar of today&rsquo;s internet. Internet is required now a days in almost all houses. Internet is mainly the interchanging of data packets between sender and receiver. In this project, I have designed a network enterprise design which is nothing but establishment of a communication channel between the sender and the receiver.</p>
<p>In wide spreading of the networking technology and securities, cyber crime is also happening now a days, so to overcome that cybercrime, cyber security is implemented. In each data packets forwarding, utmost security is given to block the unwanted data stealing from the dark web. In this project work, I have designed the network topology between internet service provider and the organization. In the given problem statement, the organization network is divided into four networks A, B, C and D each having different number of hosts. The class for the address is class C, that is there will be three blocks assigned for Network IDs and one block for Host IDs.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong><u>Brief Idea About the Project Work</u></strong></p>
<p><strong><u>&nbsp;</u></strong></p>
<p>This project is based on enterprise network design, which means we have to design a specific network topology for an enterprise that can forward data packets from the service provider to the respective organization. Here, I will simulate the network by checking all the necessary connections, that have to be established within the network. Moreover, this project is designed in such a way that it covers all the important protocols that have been implemented in networking and security now a days.</p>
<p>I have used Cisco Packet Tracer for doing the whole project. Configuring all the necessary connections and taking the cisco routers are taken into account carefully. Different types of routing protocols that is OSPF, configuring a DHCP and FTP server is also noteworthy.</p>
<p>An enterprise network consists of physical and virtual networks and protocols that serve the dual purpose of connecting all users and systems on a local area network (LAN) to applications in the data centre and cloud as well as facilitating access to network data and analytics.</p>
<p>Now a days, this network enterprise design is the most important in the field of networking and security technology and is spreading very widely day to day as we grow up.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong><u>Components and software Used</u></strong></p>
<p><strong><u>&nbsp;</u></strong></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp; <strong><u>Components Required</u></strong>:</p>
<ol>
<li>Cisco Router (Type: 2911 Router)</li>
<li>Switch (Type: 2960)</li>
<li>Laptops and personal computer as end device</li>
<li>Server</li>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cisco Packet Tracer Software</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong><u>Methodology to be adopted</u></strong></p>
<p>&nbsp;</p>
<ol>
<li>First of all, the network topology is made based on the problem statement given. Internet Service Provider (ISP) router is used as the topmost router which can provide data packets to be moved to the organization router.</li>
<li>Next, three consecutive routers of type 2961 Cisco Routers are placed for respective networks, A to D.</li>
<li>Network A and B is marked as router 0, network C is equipped with router 1, network D is implemented with router 3 based on the configuration setup.</li>
<li>After all the routers are placed properly, switch of type 2960 is placed just after router 1,2 and 3 for setup of end devices such as laptops, PCs and servers.</li>
<li>Proper connection is carried out by connecting three organization routers with Gigabyte ports and the connection between ISP and Organization router is made through Serial connectivity port.</li>
<li>Routers and switches are also connected through gigabyte ports. If in case, gigabyte ports are not available, then powering off the router, and taking LAN Cards from the physical section of the router and then again turn on the router will serve the purpose of gigabyte connectivity.</li>
<li>Connecting the switches with PCs and DHCP Servers require fast ethernet ports.</li>
<li>After making all the connections, now the main configurations are carried out inside the network. Assigning all the IP Address to each of the router through Command Line Interface window is done.</li>
<li>Setting up the DHCP and FTP Server with the IP Address and connection of VLAN is done.</li>
<li>By checking all the connections, the network enterprise design is configured and ready for sending and receiving data packets from the host to its destination address.</li>
</ol>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong><u>Explanation of the Project</u></strong></p>
<p>&nbsp;</p>
<ul>
<li><strong><u>Explanation of the components used in the project</u></strong>:</li>
</ul>
<p>&nbsp;</p>
<ol>
<li><u>ISP and Organization Router (Type 2961 Cisco Router)</u>:</li>
</ol>
<p>&nbsp;&nbsp;&nbsp;&nbsp; ISP stands for Internet Service Provider. A router basically sends data on computer networks. It is typically connected to a modem. It sends information from the internet to personal devices like computers, phones, and tablets.</p>
<p>&nbsp;</p>
<ol start="2">
<li><u>Switch (Type 2960 Cisco Switch)</u>:</li>
</ol>
